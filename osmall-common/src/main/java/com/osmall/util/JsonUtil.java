...
/**
 * Created by Johnson on 2018/10/8.
 */
@Slf4j
...
//        User u1=new User();
//        u1.setId(1);
//        u1.setEmail("test@qq.com");
//
//        User u2=new User();
//        u2.setId(2);
//        u2.setEmail("test3@qq.com");
//
//
//        String user1Json=JsonUtil.object2String(u1);
//        String user1JsonPretty=JsonUtil.object2StringPretty(u1);
